...
const Stat: React.FC<StatProps> = ({ value, label }) => (
	<div className="group cursor-pointer">
		<h1 className="text-2xl sm:text-3xl lg:text-4xl font-light transition-all duration-300 ease-out group-hover:-translate-y-2 group-hover:text-green-700">
			{value}
		</h1>
		<p className="font-light uppercase text-xs sm:text-sm pt-2 transition-colors duration-300 group-hover:text-green-600">
			{label}
		</p>
	</div>
);
