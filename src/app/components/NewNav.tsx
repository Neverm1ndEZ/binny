							...
							<div className="w-full">
								<ul className="flex items-center justify-center gap-16 py-2 rounded-lg">
									{lowerMenuItems.map((item) => (
										<li key={item.label}>
											<a href={item.href}>
												<span className="flex items-center justify-center w-20 px-3 py-2 rounded-md text-sm bg-black text-white hover:bg-gray-700 transition duration-300 ease-in-out">
													{item.label}
												</span>
											</a>
										</li>
